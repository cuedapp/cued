  ...
  it("returns application data through the router without router-owned business logic", async () => {
    const caller = appRouter.createCaller({
      ...
      services: {
        ...
        jellyfinIntegration: {} as JellyfinIntegrationService,
        seriesProgress: {} as SeriesProgressService,
        tmdbIntegration: {} as TmdbIntegrationService,
        tmdbMetadata: {} as TmdbMetadataService,
      },
    });
