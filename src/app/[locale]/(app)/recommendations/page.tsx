...
export default async function RecommendationsPage() {
  ...
  const [recommendations, ai, radarr, sonarr] = await Promise.all([recommendationService.getAll(user.id), aiIntegrationService.getOverview(), radarrIntegrationService.getOverview(), sonarrIntegrationService.getOverview()]);
