...
const items: IntentRecommendation[] = [
  ...
  { mediaType: "movie", title: "Fast Escape", overview: "An action adventure.", reasons: ["Action"], genreIds: [28, 12], score: 75, matchPercent: 80 },
  { mediaType: "movie", title: "Laugh Tonight", overview: "A warm funny comedy.", reasons: ["Comedy"], genreIds: [35], score: 70, matchPercent: 78 },
];
