...
export function MediaRatings({
  ...
  return (
    <div
      className="flex w-fit max-w-full flex-wrap items-center gap-x-5 gap-y-2 rounded-2xl border border-border/70 bg-card/80 px-4 py-2.5 shadow-sm backdrop-blur-sm"
