...
export default async function LibraryPage({ searchParams }: { searchParams: Promise<LibraryParams> }) {
  ...
  const intentPresets = (params.intent ?? "")
    .split(",")
    ...
    <div className="space-y-8">
      ...
      <LibraryFilters
        ...
        labels={{
          ...
          ratingSources: {
            jellyfin: t("ratingSources.jellyfin"),
            tmdb: t("ratingSources.tmdb"),
            imdb: t("ratingSources.imdb"),
            rottenTomatoes: t("ratingSources.rottenTomatoes"),
            metacritic: t("ratingSources.metacritic"),
            trakt: t("ratingSources.trakt"),
          },
          ratingMinimums: {
            "5": t("ratingAtLeast", { rating: 5 }),
            "6": t("ratingAtLeast", { rating: 6 }),
            "7": t("ratingAtLeast", { rating: 7 }),
