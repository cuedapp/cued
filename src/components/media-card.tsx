  ...
  return (
    ...
    >
      <div className="relative shrink-0">
        <Link
          href={href as never}
          className="block overflow-hidden rounded-t-2xl outline-none ring-offset-2 focus-visible:ring-2 focus-visible:ring-ring"
        >
      ...
      <div className="flex flex-1 items-start gap-2 p-3">
        <Link
          href={href as never}
          className="min-w-0 flex-1 rounded outline-none ring-offset-2 focus-visible:ring-2 focus-visible:ring-ring"
        >
          <h2 className="line-clamp-2 font-medium leading-5 group-hover:text-primary">{title}</h2>
