            ...
            <CardContent>
              ...
              <div className="space-y-2">
                ...
                <Link
                  ...
                  className="flex h-10 items-center justify-center rounded-lg border border-border px-3 text-sm font-medium hover:bg-accent"
                >
                  {t("viewProfile")}
                </Link>
                {user.libraries.map((library) => (
                  ...
                  >
                    <span className="min-w-0 truncate">
                      {library.name}
                      {library.selected ? "" : ` · ${t("notImported")}`}
                    </span>
                    <span
                      className={
                        library.accessible
