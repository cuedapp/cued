...
import { followService, tmdbMetadataService } from "@/server/application/services";
...
export default async function PersonPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const isFollowing = await followService.isFollowing(user.id, "person", id);
